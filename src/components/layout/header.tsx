...
export function Header() {
  ...
  return (
    <header className={cn(
        ...
        isAdminPage ? "bg-transparent" : "bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60"
    )}>
      <div className="container flex h-16 items-center">
        {isAdminPage ? (
             <div className="flex items-center gap-2">
                <SidebarTrigger className="md:hidden" />
                <h1 className="font-semibold text-lg hidden md:block">Admin Dashboard</h1>
             </div>
        ) : (
            <>
